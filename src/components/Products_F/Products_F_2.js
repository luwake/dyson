...
export default function Products_F_2 (output = 60, machine = 0, options) {
  ...
  return {
    name: '微晶元件',
    icon: '/static/img/products/f2.png',
    machine: factory,
    children: [
      Products_A_2(output * 2, 0, options),
      Products_A_1(output, 0, options)
    ],
    output
  }
}
