import Materials_A_3 from '../Materials_A/Materials_A_3'
import Machines_D_3 from '../Machines_D/Machines_D_3'
import Machines_D_4 from '../Machines_D/Machines_D_4'
import Options from '../Options'

export default function Products_A_3 (output = 60, machine = 0, options) {
  ...
  return {
    name: '钛块',
    icon: '/static/img/products/a3.png',
    machine: factory,
    children: [
      Materials_A_3(output * 2)
    ],
    output
  }
}
