...
import Products_B_7 from '../Products_B/Products_B_7'
import Products_A_3 from '../Products_A/Products_A_3'
import Options from '../Options'

export default function Products_C_8 (output = 60, machine = 0, options) {
  ...
  return {
    name: '钛晶石',
    icon: '/static/img/products/c8.png',
    machine: factory,
    children: [
      Products_B_7(output, 0, options),
      Products_A_3(output * 3, 0, options)
    ],
    output
  }
}
