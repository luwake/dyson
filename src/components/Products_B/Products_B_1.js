...
import Products_B_0 from './Products_B_0'

export default function Products_B_1 (output = 60, machine = 0, options) {
  ...
  return {
    name: '磁线圈',
    icon: '/static/img/products/b1.png',
    machine: factory,
    children: [
      Products_B_0(output, 0, options),
      Products_A_1(output * 0.5, 0, options)
    ],
    output
  }
}
